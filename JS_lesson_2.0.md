...
Если кот съел корма меньше дневной нормы, то он может съесть ещё. Если он превысил норму, то больше есть нельзя.
...
В этом задании мы потренируемся использовать операторы «больше» > и «меньше» <, занимаясь исправлением ошибок в экспериментальных разработках.
